...
export function AppShell({
  ...
  return (
    <div className="flex min-h-dvh flex-1 flex-col md:flex-row">
      ...
      <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-ash bg-bone/85 px-5 py-3 backdrop-blur-md md:hidden">
        <button
          type="button"
          ...
          className="-ml-2 inline-flex size-9 items-center justify-center rounded-full text-slate transition-colors hover:bg-ink/5 hover:text-ink"
        >
        ...
        <span className="label-sm ml-auto text-slate">{area}</span>
      </header>
      ...
      >
        <div className="flex items-center gap-2.5 border-b border-ash px-5 py-3.5">
          ...
          <button
            ...
            className="-mr-2 ml-auto inline-flex size-9 items-center justify-center rounded-full text-slate transition-colors hover:bg-ink/5 hover:text-ink md:hidden"
          >
        ...
        <p className="label-sm px-5 pt-5 pb-2 text-slate">{area}</p>
        ...
        <div className="mt-auto border-t border-ash px-5 py-4">
          <p className="truncate text-[13px] text-slate" title={email}>
            {email}
          </p>
      ...
      <main className="min-w-0 flex-1">
        <div className="mx-auto w-full max-w-5xl px-6 py-10 md:px-10 md:py-12">{children}</div>
      </main>
    </div>
  );
}
